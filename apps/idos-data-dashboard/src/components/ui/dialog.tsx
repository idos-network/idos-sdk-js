    ...
    <DialogPortal>
      ...
      >
        <DialogPrimitive.Popup
          ...
          className={cn(
            "relative row-start-2 w-full max-w-[600px] max-h-[90vh] overflow-auto bg-neutral-900 grid gap-4 rounded-xl px-6 py-4 text-sm ring-1 ring-foreground/10 outline-none duration-100 data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95",
