...
Pinocchio Enclave can be embedded in your application using an iframe. See [EMBEDDING.md](./EMBEDDING.md) for detailed integration instructions.
...
- Encryption key (KEK) is stored non-extractably in IndexedDB
