...
export type VCEnvelope = Parameters<typeof buildFaceIdCredential>[0];
export type VCKycSubject = Parameters<typeof buildKycCredential>[1];
export type VCFaceIdSubject = Parameters<typeof buildFaceIdCredential>[1];
