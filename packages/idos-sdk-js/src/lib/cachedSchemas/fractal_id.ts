export default {
  "@context": {
    ...
    residential_address_proof_category: "aux:residential_address_proof_category",
    residential_address_proof_date_of_issue: "xsd:date",
    ...
    emails: {
      "@id":
        "https://raw.githubusercontent.com/trustfractal/claim-schemas/master/verifiable_credential/fractal_id.json-ld#emails",
      "@context": {
        "@protected": true,
        address: "xsd:string",
        verified: "xsd:boolean",
