...
import w3id_security_suites_ed255192020_v1 from "./cachedSchemas/w3id_security_suites_ed255192020_v1";
...
export const cachedSchemas = {
  ...
  "https://raw.githubusercontent.com/trustfractal/claim-schemas/master/verifiable_credential/fractal_id.json-ld":
    fractal_id,
  "https://w3id.org/security/suites/ed25519-2020/v1": w3id_security_suites_ed255192020_v1,
};
