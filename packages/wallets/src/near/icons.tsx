...
export const HereIcon: React.FC<HereIconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url('#clip0_7747_53282')">
        <path d="m12.41 17.984.037.019.042-.003 17.597-1.064-1.565 2.813-17.756 1.074L.219 15.607l1.593-2.865 10.597 5.242Zm3.282-12.058-.569-2.69 1.52-2.824 2.058 6.869-3.009-1.355Zm-2.56 5.804-6.756.465-5.187-2.528 1.604-2.882 10.338 4.945Z" fill="#2C3034" stroke="#FDBF1E" stroke-width=".317"/>
        <path d="m30.366 16.76-17.88 1.082-10.825-5.32 11.722-.708L2.726 6.577 7.96 2.162 18.814 7.48 16.686 0l10.372 5.068 3.308 11.692Z" fill="#FDBF1C"/>
      </g>
      <defs>
        <clipPath id="clip0_7747_53282">
...
export const MeteorIcon: React.FC<MeteorIconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      width={size}
      height={size}
